...
// The requested 20 images from unsplash (from the prompt)
const IMAGES = [
...
export default function IntroAnimation() {
    ...
    useEffect(() => {
        ...
        const handleTouchMove = (e) => {
            if (e.cancelable) e.preventDefault(); // Stop mobile body scroll
    ...
    return (
        <div ref={containerRef} className="relative w-full h-full bg-transparent overflow-hidden rounded-2xl border border-[rgba(0,0,0,0.05)] shadow-lg !font-sans">
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                >
                    ...
                    <p className="text-sm md:text-base text-gray-600 max-w-lg leading-relaxed font-medium">
                        Our designs blur the line between utility and aesthetic. <br className="hidden md:block" />
                        Scroll down to see our global standard web deployments.
                    </p>
                </motion.div>
